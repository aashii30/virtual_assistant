...
setFrontendImage(URL.createObjectURL(file))
  ...
  return (
    <div className='w-full min-h-screen bg-gradient-to-t from-black to-[#030353] flex flex-col justify-center items-center px-4 py-8 sm:px-6 sm:py-10 md:px-10 md:py-12'>
